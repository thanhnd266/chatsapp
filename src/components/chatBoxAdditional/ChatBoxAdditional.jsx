...
import { ChatBoxAdditionalStyled } from "./styled";
      ...
      <ChatBoxAdditionalStyled>
        ...
        <div className="receiver-otherInfo">
          <div className="receiver-profile">
            <span className="receiver-info-icon">
          ...
          <div className="receiver-email">
            ...
            <span className="receiver-info-text">
              <Tooltip
                placement="top"
                title={currentReceiver && currentReceiver.email}
              >
        ...
        <div className="system-pane">
          <div
            className="accordion accordion-wrapper accordion-flush"
            ...
            {chatAdditionalInfo.map((item, index) => (
              <div className="accordion-item" key={index}>
                <h2 className="accordion-header" id="flush-headingOne">
                  <button
                    className="accordion-custom-btn accordion-button collapsed"
                    type="button"
                ...
                >
                  <div className="accordion-body">
                    {item &&
                      item.accordion.map((childItem, i) => (
                        <div
                          className="chat-feature d-flex justify-content-start align-items-center mt-2"
                          key={i}
                        >
